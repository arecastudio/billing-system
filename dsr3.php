							...
							<?php
								if (isset($_POST["proses"])&& $_POST["proses"]=="Proses"){
									...
									if(isset($_POST["rjrep"])&& $_POST["rjrep"]=="rjdaftar"){
										...
										echo"<script type=\"text/javascript\">document.getElementById(\"jrep3\").checked=\"checked\";</script>";	
										...
										,format(SUM(r.standlalu),0),format(SUM(r.standkini),0),format(SUM(r.meterai),0),format(SUM((r.adm + r.meter + r.denda)),0) as lain2  
										...
										GROUP BY r.nomor,r.periode ORDER BY m.nolama;";																				
										$qry=mysql_query($sql)or die("err: ".mysql_error());
										echo "
										<tr align=\"center\" style=\"background-color:#f0f0f0;color:#000;font-weight:bold;\">
											<td>No</td>
