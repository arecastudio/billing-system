...
?>
	...
	<tr>
		...
		<script type="text/javascript">		
			...
			function clearAll(){
				var e = document.getElementsByTagName("text");				
			...
			<div align="center" style="padding:2px 0;text-shadow:4px -4px 2px red;color:#ff0;font-size:19px;"><b>KLAIM REKENING</b></div>		
			<div class="wrapper">
