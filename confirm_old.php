	...
	<br/>
		...
		<table width="100%" border="1" cellpadding="1" cellspacing="1" align="center" bgcolor="white" style="border-collapse:collapse;background:#ffc;font-family:calibri;font-size:12px;">
			...
			if(isset($_POST["proses"])){
				...
				$sql="select m.nomor,m.nolama,SUBSTR(m.nama,1,35),SUBSTR(lcase(m.alamat),1,42),m.dkd,a.angka,b.angka,(b.angka-a.angka),m.kondisi_meter from master as m,dsmp0 as a,dsmp0 as b $slipit order by m.nolama";
				...
				$_SESSION["jumfield"]=8;
				$_SESSION["eskiel"]="select m.nomor,m.nolama,SUBSTR(lcase(m.nama),1,30),SUBSTR(lcase(m.alamat),1,30),a.angka,b.angka,(b.angka-a.angka),m.kondisi_meter from master as m,dsmp0 as a,dsmp0 as b $slipit order by m.nolama";
				$_SESSION["alinea"]=$alg;
				$_SESSION["theader"]="
