...
?>
	...
	<tr>
		...
		<table width="900px" border="0" cellpadding="1" cellspacing="1" align="center" bgcolor="white"  style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;box-shadow: 0 0 15px #999;background-color:#f0f0f0;">
            ...
            <tr>
				...
				<td>
                	<select name="opt_sambung" id="opt_sambung" style="background:linear-gradient(#fff,#ccc);color:#060;font-weight:bold;" >
                        ...
                        <option value="0">[0] Sambung</option>
                        <option value="3">[3] Putus</option>
                        <option value="5">[5] Bongkar</option>
                    </select>
                </td>
			...
			<tr>
				<td><input type="checkbox" name="chtgl">Tanggal Input</td>
				<td>
			...
			<tr>
			  <td><input type="radio" name="r1" value="perwil" />
		      Wilayah</td>
				<td>
			...
			<tr>
				<td><input type="radio" name="r1" value="perblok" />Blok</td>
				<td>
...
//	====================================================
	if(isset($_POST['proses1'])){
		...
		if ($slipit!="")$slipit=" WHERE putus=0 AND ".$slipit;
	...
	if(isset($_POST['proses2'])){
		...
		switch($radio1){
			...
			case "perupp":
				...
				break;
			case "perwil":
				if($wilayah !="")$slipit=cek_slip($slipit)."m.kode_wilayah='$wilayah'";
				$nama_key=getNama("nama_wilayah",$wilayah,"kode_wilayah","master_wilayah");//field_to_get,val_inject,index,table_name
				$judul.="<br>Wilayah: $wilayah - $nama_key";			
				break;				
			case "perblok":
				if($blok !="")$slipit=cek_slip($slipit)."m.kode_blok='$blok'";
				$nama_key=getNama("ket_blok",$blok,"kode_blok","master_blok");//field_to_get,val_inject,index,table_name
				$judul.="<br>Blok: $nama_key";			
				break;
			case "perdkd":
		...
		if(isset($_POST["chjpel"])){
			if($jpl !="")$slipit=cek_slip($slipit)."m.jenis_pel='$jpl'";
			$judul.="<br>Jenis Pel. : $jpl";			
		}
		if(isset($_POST["chkwm"])){
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~		
		...
		<tr align=\"center\" style=\"color:#000;font-weight:bold;\">
				...
				<td width=270>Alamat</td>
				<td align=\"center\">No.<br>Rumah </td>
				<td align=\"center\">RT</td>
				<td align=\"center\">RW</td>
				<td width=140 align=\"center\">Cabang</td>
		...
		";
		$sql="SELECT m.NOMOR,m.NOLAMA,m.NAMA,m.ALAMAT,m.NORUMAH,m.rt,m.rw,c.nama,m.kode_wilayah,m.kode_blok,m.DKD,m.jenis_pel,m.kondisi_meter,m.GOL
		FROM master AS m
