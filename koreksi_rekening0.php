            ...
            <tr>
                ...
                <table border="0" style="border-collapse:collapse;padding:0;border-spacing:0;font-family:arial;font-size:11px;width:100%;">
                    ...
                    if($dapat==true){
						...
						WHERE r.nomor='$nomor' AND r.status_bayar=0
...
if(isset($_POST["simpan"])){
	...
	for($i=0;$i<=$jml;$i++){
		if(isset($_POST["chk".$i])){
			...
			$q_simpan="
			INSERT INTO his_koreksi_rek(nomor,periode,standlalu,standkini,pakai,uangair,adm,meter,denda,meterai,total,tkorek,loket,operator)
			VALUES('$nomor',$prd,".$_POST["lst".$i].",".$_POST["now".$i].",".$_POST["pk".$i].",".$_POST["uair".$i].",".$_POST["adm".$i].",".$_POST["mtr".$i].",".$_POST["dnd".$i].",".$_POST["mri".$i].",".$_POST["ttl".$i].",'".$tanggal."','".$loket."','".$operator."')
