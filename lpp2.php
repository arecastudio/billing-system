								...
								if (isset($_POST["proses"])&& $_POST["proses"]=="Proses"){
									...
									//=====================================BOF=REKAP==============================================
										...
										if($periode<=201012){
											...
											LEFT OUTER JOIN master AS m ON m.nomor=r.nomor
											LEFT OUTER JOIN transaksi AS z ON z.nomor=r.nomor
											WHERE $slipit (z.tbayar BETWEEN '$tawal' AND '$takhir') AND z.periode=r.periode AND (r.periode BETWEEN $prawal AND 201012)
											GROUP BY m.gol
											ORDER BY m.gol
											;";
										}
										...
										if($ada_hapus==1){											
											...
											echo"
												<tr style=\"background-color:#ffc;color:#000;font-weight:bold;\">
													<td colspan=\"12\">Periode Rek. di bawah Tahun 2011 [200001 - 201012]</td>
												</tr>
												";
