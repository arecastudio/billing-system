...
function konversi($x){  
	...
	while($row=mysql_fetch_row($qry)){
		...
		$cetak8.="<td >Nama</td>";
		$cetak8.="<td>:</td>";
		$cetak8.="<td width=\"220\" style=\"font-size:13px;font-weight:bold;\">$row[2]</td>";
		$cetak8.="<td>Rekening Bulan</td>";
		$cetak8.="<td>:</td>";
		$cetak8.="<td width=\"100\" style=\"font-size:16px;\">$row[15]</td>";
		$cetak8.="<td>Nama</td>";
		$cetak8.="<td>:</td>";
		$cetak8.="<td>$row[2]</td>";		
		$cetak8.="</tr>";
		...
		$cetak8.="<td>:</td>";
		$cetak8.="<td style=\"font-size:16px;\">$row[6]</td>";
		...
		$cetak8.="<td>:</td>";
		$cetak8.="<td style=\"font-size:16px;\">$row[7]</td>";
		$cetak8.="<td>Denda</td>";
		$cetak8.="<td>:</td>";
		$cetak8.="<td>$row[12]</td>";
		...
		$cetak8.="<td>:</td>";
		$cetak8.="<td style=\"font-size:18px;\">$row[8] M<sup>3</sup></td>";
		$cetak8.="<td style=\"font-weight:bold;\">Total Rp.</td>";
		$cetak8.="<td>:</td>";
		$cetak8.="<td style=\"font-size:18px;\"><b>".formatMoney($row[14])."</b></td>";
		$cetak8.="<td>Jumlah Pemakaian</td>";
		$cetak8.="<td>:</td>";
		...
		$cetak8.="<td>:</td>";
		$cetak8.="<td style=\"font-size:16px;\" ><b>".formatMoney($row[14])."</b></td>";		
		$cetak8.="</tr>";
