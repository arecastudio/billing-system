					...
					<div style="height:350px;overflow:auto">
						<table width="100%" border="1" cellpadding="1" cellspacing="1" align="center" style="border-collapse:collapse;background:#fff;font-family:calibri;font-size:12px;">
                            ...
                            if(isset($_POST['proses'])&&$_POST['proses']=='Proses'){							
								...
								$slipit=cek_slip($slipit)." m.putus='$putus' and r.tbayar<'$takhir' ";
								
								$sql_i[1]="SELECT DISTINCT  m.gol,(select distinct t.keterangan from tarif t where t.gol=m.gol LIMIT 0,1)as ket,COUNT(*) as jml_rek,SUM(r.pakai) as jpakai,SUM(r.uangair) as juangair,SUM(r.adm) as jadm,SUM(r.meter) as jmeter,SUM(r.meterai) as jmeterai,SUM((r.uangair + r.adm + r.meter + r.meterai + r.denda)) as jtotal,ROUND(IFNULL((SUM(r.uangair)/SUM(r.pakai)),0),0) as avg_harga, ROUND(IFNULL((SUM(r.pakai)/COUNT(*)),0),0) as avg_plg FROM rekening1 AS r INNER JOIN master AS m ON m.nomor=r.nomor WHERE r.periode=$bln1 AND r.status_bayar=0 AND $slipit GROUP BY m.gol;";
								$sql_i[2]="SELECT DISTINCT  m.gol,(select distinct t.keterangan from tarif t where t.gol=m.gol LIMIT 0,1)as ket,COUNT(*) as jml_rek,SUM(r.pakai) as jpakai,SUM(r.uangair) as juangair,SUM(r.adm) as jadm,SUM(r.meter) as jmeter,SUM(r.meterai) as jmeterai,SUM((r.uangair + r.adm + r.meter + r.meterai + r.denda)) as jtotal,ROUND(IFNULL((SUM(r.uangair)/SUM(r.pakai)),0),0) as avg_harga, ROUND(IFNULL((SUM(r.pakai)/COUNT(*)),0),0) as avg_plg FROM rekening1 AS r INNER JOIN master AS m ON m.nomor=r.nomor WHERE (r.periode BETWEEN $bln3 AND $bln2) AND r.status_bayar=0 AND $slipit GROUP BY m.gol;";
								$sql_i[3]="SELECT DISTINCT  m.gol,(select distinct t.keterangan from tarif t where t.gol=m.gol LIMIT 0,1)as ket,COUNT(*) as jml_rek,SUM(r.pakai) as jpakai,SUM(r.uangair) as juangair,SUM(r.adm) as jadm,SUM(r.meter) as jmeter,SUM(r.meterai) as jmeterai,SUM((r.uangair + r.adm + r.meter + r.meterai + r.denda)) as jtotal,ROUND(IFNULL((SUM(r.uangair)/SUM(r.pakai)),0),0) as avg_harga, ROUND(IFNULL((SUM(r.pakai)/COUNT(*)),0),0) as avg_plg FROM rekening1 AS r INNER JOIN master AS m ON m.nomor=r.nomor WHERE (r.periode BETWEEN $bln6 AND $bln4) AND r.status_bayar=0 AND $slipit GROUP BY m.gol;";
								$sql_i[4]="SELECT DISTINCT  m.gol,(select distinct t.keterangan from tarif t where t.gol=m.gol LIMIT 0,1)as ket,COUNT(*) as jml_rek,SUM(r.pakai) as jpakai,SUM(r.uangair) as juangair,SUM(r.adm) as jadm,SUM(r.meter) as jmeter,SUM(r.meterai) as jmeterai,SUM((r.uangair + r.adm + r.meter + r.meterai + r.denda)) as jtotal,ROUND(IFNULL((SUM(r.uangair)/SUM(r.pakai)),0),0) as avg_harga, ROUND(IFNULL((SUM(r.pakai)/COUNT(*)),0),0) as avg_plg FROM rekening1 AS r INNER JOIN master AS m ON m.nomor=r.nomor WHERE (r.periode BETWEEN $bln12 AND $bln7) AND r.status_bayar=0 AND $slipit GROUP BY m.gol;";
								
								$sql_i[5]="SELECT DISTINCT  m.gol,(select distinct t.keterangan from tarif t where t.gol=m.gol LIMIT 0,1)as ket,COUNT(*) as jml_rek,SUM(r.pakai) as jpakai,SUM(r.uangair) as juangair,SUM(r.adm) as jadm,SUM(r.meter) as jmeter,SUM(r.meterai) as jmeterai,SUM((r.uangair + r.adm + r.meter + r.meterai + r.denda)) as jtotal,ROUND(IFNULL((SUM(r.uangair)/SUM(r.pakai)),0),0) as avg_harga, ROUND(IFNULL((SUM(r.pakai)/COUNT(*)),0),0) as avg_plg FROM rekening1 AS r INNER JOIN master AS m ON m.nomor=r.nomor WHERE (r.periode BETWEEN $bln24 AND $bln13) AND r.status_bayar=0 AND $slipit GROUP BY m.gol;";
								$sql_i[6]="SELECT DISTINCT  m.gol,(select distinct t.keterangan from tarif t where t.gol=m.gol LIMIT 0,1)as ket,COUNT(*) as jml_rek,SUM(r.pakai) as jpakai,SUM(r.uangair) as juangair,SUM(r.adm) as jadm,SUM(r.meter) as jmeter,SUM(r.meterai) as jmeterai,SUM((r.uangair + r.adm + r.meter + r.meterai + r.denda)) as jtotal,ROUND(IFNULL((SUM(r.uangair)/SUM(r.pakai)),0),0) as avg_harga, ROUND(IFNULL((SUM(r.pakai)/COUNT(*)),0),0) as avg_plg FROM rekening1 AS r INNER JOIN master AS m ON m.nomor=r.nomor WHERE (r.periode BETWEEN $bln36 AND $bln25) AND r.status_bayar=0 AND $slipit GROUP BY m.gol;";
								$sql_i[7]="SELECT DISTINCT  m.gol,(select distinct t.keterangan from tarif t where t.gol=m.gol LIMIT 0,1)as ket,COUNT(*) as jml_rek,SUM(r.pakai) as jpakai,SUM(r.uangair) as juangair,SUM(r.adm) as jadm,SUM(r.meter) as jmeter,SUM(r.meterai) as jmeterai,SUM((r.uangair + r.adm + r.meter + r.meterai + r.denda)) as jtotal,ROUND(IFNULL((SUM(r.uangair)/SUM(r.pakai)),0),0) as avg_harga, ROUND(IFNULL((SUM(r.pakai)/COUNT(*)),0),0) as avg_plg FROM rekening1 AS r INNER JOIN master AS m ON m.nomor=r.nomor WHERE (r.periode >$prd_batas AND r.periode<=$bln37) AND r.status_bayar=0 AND $slipit GROUP BY m.gol;";
								$sql_i[8]="SELECT DISTINCT  m.gol,(select distinct t.keterangan from tarif t where t.gol=m.gol LIMIT 0,1)as ket,COUNT(*) as jml_rek,SUM(r.pakai) as jpakai,SUM(r.uangair) as juangair,SUM(r.adm) as jadm,SUM(r.meter) as jmeter,SUM(r.meterai) as jmeterai,SUM((r.uangair + r.adm + r.meter + r.meterai + r.denda)) as jtotal,ROUND(IFNULL((SUM(r.uangair)/SUM(r.pakai)),0),0) as avg_harga, ROUND(IFNULL((SUM(r.pakai)/COUNT(*)),0),0) as avg_plg FROM rekening1 AS r INNER JOIN master AS m ON m.nomor=r.nomor WHERE r.periode<=$prd_batas AND r.status_bayar=0 AND $slipit GROUP BY m.gol;";
