...
<tr>
	<td>
		...
		<table width="700px" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF" align="center" class="wrapper"  style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;box-shadow: 0 0 15px #999;background-color:#f0f0f0;">
		...
		<br/>
		<!--######################################################################-->
		<table width="710px" align="center" border="0" cellpadding="0" cellspacing="0" style="box-shadow: 0 0 15px #999;">
		<tr>
		...
		<table width="100%" border="1" cellpadding="1" cellspacing="1" align="center" bgcolor="white" style="border-collapse:collapse;background:#ffc;font-family:calibri;font-size:12px;">
			...
			if(isset($_POST["proses"])){
				...
				switch($r2){
					case"belum":
						$slipit=cek_slip($slipit)."b.angka=0";
						$judul.="<br>Stand Mtr: Belum Terisi";
						break;
					//case"nol":
					...
					case"kurang":
						...
						$judul.="<br>Stand Mtr: Pemakaian Lebih Kecil atau Setara [$nkecil]";
						break;
					case"lebih":
						if($pbesar!="")$nbesar=$pbesar;
						$slipit=cek_slip($slipit)."(b.angka-a.angka)>$nbesar";
						$judul.="<br>Stand Mtr: Pemakaian Lebih Besar atau Setara [$nbesar]";
						break;
				}
				...
				$alg=array("center","center","left","left","center","right","right","right");
				$sql="select m.nomor,m.nolama,m.nama,m.alamat,m.dkd,a.angka,b.angka,(b.angka-a.angka) from master as m,dsmp0 as a,dsmp0 as b $slipit order by m.nolama";
				...
				<tr width=\"100%\">
					<td width=\"300\" align=\"center\">
						Dibuat oleh,<br>
						Ka. Ur<br><br><br><br><br>
						...............................<br>NIK.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
					<td width=\"300\" align=\"center\">
						Diketahui oleh,<br>
						Ka. UPP<br><br><br><br><br>
						...............................<br>
						NIK.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
				</tr></table>
