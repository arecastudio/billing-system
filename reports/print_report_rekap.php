<?php
	...
	$t_open="<table align=\"left\" border=\"1\" style=\"border-collapse:collapse;background:#fff;font:Times;font-size:11px;width:1024px;\">
			".$theader;
	$t_close="";
	...
	//if($qry){
	$re=0;$cetak8="";
	$cetak8 .= "<page><div align=\"right\"></div>".$header1."<table align=\"left\" border=\"1\"  style=\"border-style:dotted;border-collapse:collapse;background:#fff;font:Times;font-size:11px;border-spacing:1px;padding:1px;width:1024px;\">".$theader;	
	$y=0;
