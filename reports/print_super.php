<?php
	...
	if($ttd=="YOHAN WANGGAI, SE"){
		...
		$lks="
		<br/>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dari data tersebut diatas, kami mohon untuk segera ke  <b>Kantor Perusahaan Daerah Air Minum </b><br/>
		<b>(PDAM UPP.Jayapura) Jl. Baru Kelapa Dua Entrop </b> setiap hari kerja, apabila belum menyelesaikan <br/>
		tunggakan tersebut maka dengan sangat terpaksa kami akan melakukan <b>pemutusan/penyegelan</b>. <br/>
		Mohon di abaikan pemberitahuan ini apabila Bapak/Ibu telah menyelesaikan tunggakan rekening air <br/>
		tersebut.<br/><br/>
		
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian penyampaian kami, atas kerjasamanya dihaturkan terima kasih.<br/>
	...
	while($i<$jdata){		
		...
		$cetak8 .="<tr><td>Perihal</td><td>:</td><td>Pemberitahuan Tunggakan Rekening Air</td><td>No. Sambungan</td><td>:</td><td>$nomor[$i]</td></tr>";
