...
<tr>
	...
	<br/>
		...
		<br/>
		<!--######################################################################-->
		<table background="img/grids.gif" width="710px" align="center" border="0" cellpadding="0" cellspacing="0" style="box-shadow: 0 0 15px #999;">
		<tr>
		...
		<table width="100%" border="1" cellpadding="1" cellspacing="1" align="center" bgcolor="white" style="border-collapse:collapse;background:#ffc;font-family:calibri;font-size:12px;">
			...
			if(isset($_POST["proses"])){
				...
				$sql="select m.nomor,m.nolama,SUBSTR(m.nama,1,20),SUBSTR(m.alamat,1,30),m.dkd,a.angka,b.angka,(b.angka-a.angka) from master as m,dsmp0 as a,dsmp0 as b $slipit order by m.nolama";
