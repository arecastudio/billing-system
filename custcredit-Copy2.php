...
if(isset($_POST['cari'])){
	...
	$query="select m.nomor,m.nolama,m.nama,m.dkd,d.jalan,m.alamat,m.norumah,m.rt,m.rw,m.kode_pos,m.cabang,c.nama from master as m,dkd as d,cabang as c where c.cabang=m.cabang and m.dkd=d.dkd and m.nomor='$nomor' or m.nolama='$nolama'";
