...
&nbsp;
&nbsp;
<select id="opt_alasan" name="opt_alasan" required >
<option value="">--Alasan Koreksi--</option>
<option value="Salah baca meter">Salah baca meter</option>
<option value="Air tidak mengalir">Air tidak mengalir</option>
<option value="Keberatan bayar">Keberatan bayar</option>
<option value="Ada kebocoran">Ada kobocoran</option>
<option value="Meter tidak normal">Meter tidak normal</option>
...
if(isset($_POST["simpan"])){
	...
	for($i=0;$i<=$jml;$i++){
		if(isset($_POST["chk".$i])){
			...
			$q_simpan="
			INSERT INTO his_koreksi_rek(nomor,periode,standlalu,standkini,pakai,uangair,adm,meter,denda,meterai,total,tkorek,loket,operator,standlalu_awal,standkini_awal,pakai_awal,uangair_awal,adm_awal,meter_awal,denda_awal,meterai_awal,total_awal,tdisposisi,alasan)
