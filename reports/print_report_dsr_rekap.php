<?php
	...
	$t_open="<table align=\"left\" border=\"1\" style=\"border-style:dashed;border-collapse:collapse;background:#fff;font:Times;font-size:12px;width:1024px;\">
			".$theader;
	$t_close="";
	...
	//if($qry){
	$re=0;$cetak8="";
	$cetak8 .= "<page><div align=\"right\"></div>".$header1."<table align=\"left\" border=\"1\"  style=\"border-style:dashed;border-collapse:collapse;background:#fff;font:Times;font-size:12px;border-spacing:2px;padding:2px;width:1024px;\">".$theader;	
	...
	while($row=mysql_fetch_row($qry)){
		...
		if($re<=1){
			//$cetak8 .= "<page>";
			//$cetak8 .= "<page><table align=\"center\" width=\"800\" border=\"1\"  style=\"border-collapse:collapse;background:#ffc;font:Times;font-size:12px;\">";
			//$cetak8 .= $theader;
			//re= jml batas record halaman bawah
		}else if($re > $batas){
			$hal++;
			$cetak8 .= "</table>".$footer1."</page><page><div align=\"right\"></div>".$header1."<table align=\"left\" border=\"1\"  style=\"border-style:dashed;border-collapse:collapse;background:#fff;font:Times;font-size:12px;border-spacing:2px;padding:2px;width:1024px;\">".$theader;
			$re=0;
			//++$hal;
		}
		...
		for($i=0;$i<$nmr;$i++){
			...
			if($i==3){
				$cetak8 .="<td align=\"$alg[$i]\">".ucwords(trim($row[$i]))."</td>";
			}else{
				$cetak8 .="<td align=\"$alg[$i]\">".trim($row[$i])."</td>";
			}
		}
