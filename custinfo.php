	...
	<tr>
		...
		<table width="900px" border="0" cellpadding="1" cellspacing="1" align="center" bgcolor="white"  style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;box-shadow: 0 0 15px #999;background-color:#f0f0f0;">
			...
			<tr>
                ...
                <td><input type="checkbox" name="chtgl"  id="chtgl">Tanggal Input</td>
				<td>
					<input type="text" size="11" maxlength="10" name="txtawal" id="txtawal" class="datepicker"   />
					&nbsp;<i>s/d</i>&nbsp;
					<input type="text" size="11" maxlength="10" name="txtakhir" id="txtakhir" class="datepicker"   />
			...
			<tr>
				...
				<td><input name="jreport" id="jreport1" type="radio" value="detail" checked="checked"/>Detail</td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td><input name="jreport" id="jreport2" type="radio" value="rekap"/>Rekap</td>
		...
		<table id="tabel_hasil" width="100%" border="1" cellpadding="1" cellspacing="1" align="center" bgcolor="white" style="border-collapse:collapse;background:#ffc;font-family:calibri;font-size:12px;">
...
//	====================================================
	if(isset($_POST['proses1'])){
		...
		if(isset($_POST["chtgl"])){
			...
			echo"<script type=\"text/javascript\">document.getElementById(\"txtawal\").value=\"$tgl_awal\";</script>";
			echo"<script type=\"text/javascript\">document.getElementById(\"txtakhir\").value=\"$tgl_akhir\";</script>";
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~		
		...
		";
		$sql="SELECT DISTINCT m.NOMOR,m.NOLAMA,m.NAMA,m.ALAMAT,m.NORUMAH,m.rt,m.rw,if(m.cabang='02','UPP JAPUT',c.nama),m.kode_wilayah,m.kode_blok,m.DKD,m.jenis_pel,m.kondisi_meter,m.GOL
		FROM master AS m
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			...
			//$key2=$_POST["jreport"]=="rekap";
			echo"<script type=\"text/javascript\">document.getElementById(\"jreport2\").checked=\"checked\";</script>";
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			...
			<tr>
				<td>
					<input type="button" name="export" value="Export to Excel" onClick ="$('#tabel_hasil').tableExport({type:'excel',escape:'false',htmlContent:'true'});" style="color:#00f;font-size:12px;font-weight:bold;padding:0px;"/>
				</td>
			</tr>
		</table><br />
		</td>
