...
function getBulan($numBul){
	...
	$header1="		
		<table cellpadding=0 cellspacing=0 border=0><tr><td><img heigh=60 width=60 src=\"pdam-1.jpg\"></td><td align=center width=600 style=\"font:arial;font-size:13;align:center\">PERUSAHAAN DAERAH AIR MINUM<br>JAYAPURA. <i style=\"font-weight:bold;\">www.pdamjayapura.com</i></td></tr></table><hr>
	...
	while($row=mysql_fetch_row($qry)){
		$s_peri=getBulan(substr($row[15],4,2))."-".substr($row[15],0,4);
		...
		$cetak8.="<td width=\"100\" style=\"font-size:13px;font-weight:bold;\">$s_peri</td>";
		$cetak8.="<td>Nama</td>";
		$cetak8.="<td>:</td>";
		$cetak8.="<td>$row[2]</td>";		
		$cetak8.="</tr>";
		...
		$cetak8.="<td>:</td>";
		$cetak8.="<td style=\"font-size:16px;font-weight:bold;\">$row[0] / $row[1]</td>";
		...
		$cetak8.="<td>Rekening Bulan</td>";
		$cetak8.="<td>:</td>";
		//$cetak8.="<td style=\"font-size:14px;\">$row[15]</td>";		
		$cetak8.="<td style=\"font-size:14px;\">$s_peri</td>";		
		$cetak8.="</tr>";
		...
		$cetak8.="<tr>";	
		$cetak8.="<td style=\"font-weight:bold;\" >Loket Bayar</td>";
		$cetak8.="<td style=\"font-weight:bold;\">:</td>";
		$cetak8.="<td style=\"font-weight:bold;\">".$nloket."</td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Petugas Loket :&nbsp;&nbsp;".$_SESSION['nama_user']."</b>";
		$cetak8.="<td>&nbsp;</td>";
		$cetak8.="<td>&nbsp;</td>";
		$cetak8.="<td>&nbsp;</td>";

		$cetak8.="<td  style=\"font-weight:bold;\">Petugas Loket</td>";
		$cetak8.="<td>:</td>";
		$cetak8.="<td  style=\"font-weight:bold;\">".$_SESSION['nama_user']."</td>";
		$cetak8.="<td>&nbsp;</td>";
		//$cetak8.="<td>&nbsp;</td>";
		//$cetak8.="<td>&nbsp;</td>";
		//$cetak8.="<td>&nbsp;</td>";
